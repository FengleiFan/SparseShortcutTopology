...
from SparseShortcutTopologyModels import *
...
model_ft = s3net_new() # train from stratch
...
train_model("xxxx",model_ft, dataloaders, dataset_sizes, criterion, optimizer_ft, num_epochs=90)
